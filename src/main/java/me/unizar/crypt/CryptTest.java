...
public class CryptTest {
	...
	/*public static void main(String[] args) throws FileNotFoundException{
		...
		TPSManager.init();
		TIMER.schedule(new TimerTsk(), 50L);
	}*/
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String bad_passwd = "abcdefghijklmnopqrstuuwxyz";
		//String test_hash = "$2a$06$.rCVZVOThsIa97pEDOxvGuRRgzG64bvtJ0938xuqzv18d3ZpQhstC";
		String test_hash = "$2a$12$9FXECUXeMXBFbpupi6vAm./Wds/CLt6.Zgnn/hjWFHyUO8qQN2BeK";
		...
		System.err.println("Encrypt took " + (t1 - t0) + "ms.");
		...
		test(test_passwd, test_hash, computed_hash);
		Thread.sleep(100);
		test(bad_passwd, test_hash, computed_hash);

	}

	private static void test(String test_passwd, String test_hash, String computed_hash){
		long t0, t1;
		t0 = System.currentTimeMillis();
		String compare_test = checkPassword(test_passwd, test_hash)
				? "Passwords Match" : "Passwords do not match";
		t1 = System.currentTimeMillis();
		System.err.println("Check1 took " + (t1 - t0) + "ms.");

		t0 = System.currentTimeMillis();
		String compare_computed = checkPassword(test_passwd, computed_hash)
				? "Passwords Match" : "Passwords do not match";
		t1 = System.currentTimeMillis();
		System.err.println("Check2 took " + (t1 - t0) + "ms.");
